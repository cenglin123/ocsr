...
IMPL = ROOT / "scripts" / "ocsr_run_spec.py"
DISPATCH = ROOT / "scripts" / "ocsr_dispatch.py"

_SPEC = importlib.util.spec_from_file_location("ocsr_run_spec_test", IMPL)
...
class TestCli:
    ...
    def test_dispatch_step_is_blocked_by_tripwire(self):
        ...
        因此必须同样受 `OCSR_DISABLE_MODEL_CALLS` tripwire 管辖。
